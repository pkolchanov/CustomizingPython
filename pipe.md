...
2. Load value of `b` to the stack using `LOAD_NAME`
3. Load value of `a` to the stack using `LOAD_NAME`
...
Fine. Finally, we need to add `e->v.PipeOp.left` to `v.Call.args` 
